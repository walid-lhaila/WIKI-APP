...
<div class="px-20 mt-20">
  ...
  <div class="flex justify-star">
    ...
    <div class="flex justify-center">
        ...
        <div id="wiki" class="flex flex-wrap justify-center mt-24 gap-5">
        ...
        <div class="flex justify-center mt-24">
            <h1 class="font-bold text-black text-3xl">Category</h1>
        </div>
        <div id="category" class="flex flex-wrap gap-10 justify-center mt-24 ">
        ...
        <div class="flex justify-center mt-24">
            <h1 class="font-bold text-black text-3xl">Tags</h1>
        </div>
        <div id="tags" class="flex flex-wrap gap-10 justify-center mt-24 ">
...
<footer class="bg-white dark:bg-gray-800 mt-28">
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#">
                        <img class="w-auto h-7" src="<?php echo URLROOT?>/img/icons8-wiki-48.png" alt="">
                    </a>
...
<script defer src="<?php echo URLROOT?>/js/wikiV.js"></script>
<script defer src="<?php echo URLROOT?>/js/categoryV.js"></script>
<script defer src="<?php echo URLROOT?>/js/tagV.js"></script>
