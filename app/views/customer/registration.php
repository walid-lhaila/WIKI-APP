  ...
  <form id="form" class="space-y-8 divide-y divide-gray-200">
    ...
    <div class="pt-5">
      <div class="flex justify-center">
        ...
        <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-800 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Save
        </button>
      </div>
    </div>
